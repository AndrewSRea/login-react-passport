import React, { useContext } from "react"; //START AT 1:09:58 <OPEN UP "pages/Home.jsx"
import { Link } from "react-router-dom";
import UserDropDown from "./UserDropDown";
import UserProvider from "../../contexts/UserProvider";
import { data } from "../../data";
import _ from "lodash";
import PassportLogo from "../../res/passport.png";
...
const MenuBar = () => {
    ...
    const loginType = !_.isEmpty(userData) ? _.find(data, d => d.name === userData.provider) : {}; //mark 1:06:00
